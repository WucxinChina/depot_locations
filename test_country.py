...
def test_travel_time():
    ...
    time = country.travel_time(loc1, loc2)
    assert time > 0, "Expected travel time should be greater than 0."

def test_nearest_neighbour_path():
    ...
    path = country.nearest_neighbour_path(depot)
...
def test_best_depot_location():
    ...
    best_depot = country.best_depot_location()
